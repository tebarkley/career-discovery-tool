...
def get_jobs(num_jobs=500, invalid=invalid):
    ...
    for i, job_id in enumerate(job_ids):
        parameters = {'DeveloperKey': settings.CB_API_KEY_CAM, 
                      'DID': job_id}
...
if invalid:
	...
	invalid_series.to_pickle(path.join(pardir, pardir, 'data', 'cam_invalid_job_ids.pickle'))
...
all_jobs.to_pickle(path.join(pardir, pardir, 'data', 'cam_job_descriptions.pkl'))